...
public class Board {
	...
	// These are lists that keep track of player pieces. 
	...
	// Constructor for different versions of the game
	...
	// Basic search method // Used in checkMill
	...
	// Reads a text file with all the valid spaces and their valid connections. // reads different file based on chosen game type
