...
public class Main extends Application implements EventHandler<ActionEvent> {
	...
	public void start(Stage stage) throws Exception{
		...
		button25 = new Piece(); pieces.add(button25);
        ...
        button25.setOnAction(new EventHandler<ActionEvent>() {
            @Override 
            public void handle(ActionEvent e) {SpaceButtonHandler(button25);}});
	}
	...
	public boolean readButtonData() {
		try (Scanner scanner = new Scanner(new File("src\\spaces.txt"))) {
